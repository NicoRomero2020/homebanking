...
public class WebAuthorization extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.POST, "/api/clients/validate/card").permitAll()
                .antMatchers(HttpMethod.POST, "/api/clients/current/accounts").hasAuthority("USER")
                .antMatchers(HttpMethod.POST, "/api/clients/current/cards").hasAuthority("USER")
                .antMatchers(HttpMethod.POST, "/api/clients/current/loans").hasAuthority("USER")
